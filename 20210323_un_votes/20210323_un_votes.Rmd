...
p <- dat %>% 
 ...
 theme(
  ...
  plot.subtitle = element_markdown(size = 16, margin = margin(.5,0,3,0, unit = "cm"), hjust = .5),
  plot.caption = element_markdown(hjust = .5, margin = margin(1,0,0,0, unit = "cm")),
  plot.caption.position = 'plot'
 )
 
ggsave("votes.png", p, device = "png", width = 15, height = 10, units = "in", dpi = 300)
