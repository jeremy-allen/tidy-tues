...
p <- dat %>% 
 ...
 theme(
  ...
  plot.subtitle = element_markdown(size = 16, margin = margin(.5,0,2,0, unit = "cm"), hjust = .5),
  plot.caption = element_markdown(size = 14, hjust = .5, margin = margin(1,0,0,0, unit = "cm")),
  plot.caption.position = 'plot'
 )
 
ggsave(here::here("20210323_un_votes", "votes.png"), p, device = "png", width = 15, height = 10, units = "in", dpi = 300)
